        ...
        <div className={`${stepOneColor?'block':'hidden'} sm:-mt-10 md:-mt-0 lg:-mt-10`}>
            <div className="sm:bg-white sm:rounded-lg sm:mx-6 sm:p-6 lg:p-12  ">
                    ...
                    <div className='flex flex-col mt-8'>
                        ...
                        <input type='text' placeholder="e.g, John Doe" value={name} onChange={(e)=>nameHandler(e.target.value)} className={`appearance-none w-full h-12 border-2 border-gray-200 pl-4 rounded-lg hover:border-purple-700 hover:border focus:border  ${nameError?" placeholder-red-400":''}`}/>
                    </div>
                    ...
                    <div className='flex justify-between'>
                        ...
                        <input type='text' placeholder="e.g, test@gmail.com" value={email} onChange={(e)=>emailHandler(e.target.value)}  className={` appearance-none w-full h-12 border-2 border-gray-200 pl-4 rounded-lg hover:border-purple-700 hover:border focus:border ${emailError?" placeholder-red-400":''}`}/>
                    </div>
                    <div className='flex flex-col mt-6'>
                    <div className='flex justify-between'>
                        ...
                        <input type='text' placeholder="e.g, +1 234 567 890" value={phone} onChange={(e)=>phoneHandler(e.target.value)} className={`appearance-none w-full h-12  border-2 border-gray-200 pl-4 rounded-lg hover:border-purple-700 hover:border focus:border ${phoneError?" placeholder-red-400":''}`}/>
                    </div>
